...
if ($_SESSION[Database_Name()."session_level"] > 1) {
    ...
    $sql = "UPDATE medlemskab SET 
                Adresse = '" . test_input($jretval->Adresse) .
            "', Adresse2 = '" . test_input($jretval->Adresse2) .
            "', PostNummer = '" . test_input($jretval->Postnummer) .
            "', ByNavn = '" . test_input($jretval->Bynavn) .
            "', Land = '" . test_input($jretval->Land) .
            "', Comments = '" . test_input($jretval->Kommentar) .
            "' WHERE ID = " . $jretval->ID;
