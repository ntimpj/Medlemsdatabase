...
<?php
        ...
        else 
        {
            ...
            else 
            {
             ...
             //   $_SESSION[Database_Name()."session_username"] = $firstrow['username'];
                $_SESSION[Database_Name()."session_first_name"] = $firstrow['first_name'];
                $_SESSION[Database_Name()."session_last_name"] = $firstrow['last_name'];
                $_SESSION[Database_Name()."session_email"] = $firstrow['email'];
                $_SESSION[Database_Name()."session_level"] = $firstrow['priviledge'];
