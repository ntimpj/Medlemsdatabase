...
//Insert the new property into medlemstalenter table
    $sql = "INSERT INTO medlemstalenter (TalentID, MedlemsID) VALUES(". test_input($jretval->PropertyID).", ".test_input($jretval->MemberID).")" ;
