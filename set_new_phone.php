...
if ($_SESSION[Database_Name()."session_level"] > 1) {
    ...
    //Insert the new phone into member table
    $sql = "INSERT INTO telefon (TelefonNummer, Mobil, MedlemsID) VALUES ('" . test_input($jretval->Phone) . "'," . test_input($jretval->IsMobil) . "," . test_input($jretval->MemberID) . ")";
