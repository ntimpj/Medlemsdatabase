...
if ($_SESSION[Database_Name()."session_level"] > 1) {
    ...
    $sql = "SELECT betalinger.ID, kontingent.BetalingsNavn, betalinger.BetalingsDate, kontingent.Beloeb  FROM betalinger INNER join kontingent On betalinger.KontingentID = kontingent.ID  AND betalinger.MedlemsID = " . $data->membernumber;
