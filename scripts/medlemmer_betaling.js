...
function BetalingTabel()
{
    ...
    //var member = document.getElementById('membernumber');
    //var memberNo = document.getElementById('membernumber').innerHTML;
...
function FillBetalingsDialog()
{
    ...
    var ipName = document.getElementById('navn');
    MyModalText.innerHTML = "Registrer Kontingent Betaling for " + ipNumber.innerHTML + " " + ipName.value;
...
function SendBetaling()
{
    ...
    //make json to send to database php
    var sendval = JSON.stringify({konID: document.getElementById('betalid').innerHTML, msID: document.getElementById('membernumber').innerHTML});
    xmlhttp.send(sendval);
...
{
    //var id = document.getElementById('membernumber').innerHTML;
    //var Navn = document.getElementById('navn').value;
    document.getElementById('removetext').innerHTML = "Fjern Kontingent Betaling for " + document.getElementById('membernumber').innerHTML + " " + document.getElementById('navn').value;
